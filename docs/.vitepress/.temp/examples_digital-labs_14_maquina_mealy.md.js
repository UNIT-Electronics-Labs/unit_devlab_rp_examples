...
const __pageData = JSON.parse('{"title":"14 Maquina Mealy","description":"","frontmatter":{},"headers":[],"relativePath":"examples/digital-labs/14_maquina_mealy.md","filePath":"examples/digital-labs/14_maquina_mealy.md"}');
const _sfc_main = { name: "examples/digital-labs/14_maquina_mealy.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="_14-maquina-mealy" tabindex="-1">14 Maquina Mealy <a class="header-anchor" href="#_14-maquina-mealy" aria-label="Permalink to &quot;14 Maquina Mealy&quot;">​</a></h1><p>Practica de maquina de estados tipo Mealy para detectar la secuencia <code>101</code>.</p><h2 id="objetivo" tabindex="-1">Objetivo <a class="header-anchor" href="#objetivo" aria-label="Permalink to &quot;Objetivo&quot;">​</a></h2><p>Implementar una FSM donde la salida depende del estado actual y de la entrada.</p><h2 id="verilog" tabindex="-1">Verilog <a class="header-anchor" href="#verilog" aria-label="Permalink to &quot;Verilog&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#005CC5", "--shiki-dark": "#79B8FF" })}">cd</span><span style="${ssrRenderStyle({ "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" })}"> digital-labs/14_maquina_mealy</span></span>
