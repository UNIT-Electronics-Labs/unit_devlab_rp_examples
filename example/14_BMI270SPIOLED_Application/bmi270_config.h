 ...
 * @brief Archivo de configuracion (firmware interno) del BMI270.
 *
 * Contenido extraido sin modificaciones del driver oficial de Bosch
 * Sensortec (bmi270.c), necesario para la inicializacion del sensor:
 * el BMI270 no produce datos de aceleracion ni giro hasta que este
 * bloque de 8192 bytes se carga en el registro INIT_DATA.
 *
 * Origen:    https://github.com/boschsensortec/BMI270_SensorAPI
 * Autor:     Bosch Sensortec GmbH
